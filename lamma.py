...
# HUGGINGFACE_API_KEY = os.getenv("HUGGINGFACE_API_KEY")  # If using cloud API
...
def ask_question(query: UserQuery):
    ...
    try:
        ...
        final_prompt = f"Summarize the following database query result: {result_text}"
        summary = generate_response(final_prompt)
